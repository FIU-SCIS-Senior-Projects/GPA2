...
angular.module('semesterForecastApp', ['ngMaterial', 'md.data.table', 'chart.js'])
    ...
    if (classesImported) {
        ...
        if(formattedGPAGoal > maxGoalGPA) {
            ...
            var sum = '<p class="heading" id="heading" align="center"><strong>Current GPA:</strong> ' + accurateGPA.toFixed(2) + '<br><strong>Graduation Goal GPA:</strong> ' + formattedGPAGoal.toFixed(2) + '<br><strong>Semester Goal GPA:</strong> ' + semesterGoal.toFixed(2) + '<br><strong>Credits Remaining:</strong> ' + creditsLeft + '<br></p><p class="inorder">In order to your Graduation Goal GPA of ' + formattedGPAGoal.toFixed(2) + ', you require an average Semester GPA of ' + semesterGoal.toFixed(2) + '. The following forecast has been generated according to the weight and relevance you provided:</p>';
